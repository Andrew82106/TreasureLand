...
const MARKERS := [
	...
	{"id": "road_sign", "label": "海边路牌", "position": Vector2(1015, 760), "color": Color("c5d8b0"), "area": "漂流湾"},
	...
	{"id": "exchange", "label": "潮汐商会", "position": Vector2(1812, 700), "color": Color("d5bd73"), "area": "椰影街"},
	{"id": "news", "label": "岛报栏", "position": Vector2(2014, 680), "color": Color("f4e1a1"), "area": "椰影街"},
	{"id": "lifestyle", "label": "生活陈列店", "position": Vector2(1285, 770), "color": Color("d5b7d9"), "area": "椰影街"},
	{"id": "square", "label": "公共广场", "position": Vector2(1735, 790), "color": Color("b6d8c8"), "area": "椰影街"},
	...
	{"id": "race", "label": "赛事大厅", "position": Vector2(2488, 555), "color": Color("7ee0a2"), "area": "逐风海岸"},
	{"id": "race_ticket", "label": "祝胜券窗口", "position": Vector2(2630, 590), "color": Color("8ed7a7"), "area": "逐风海岸"},
	{"id": "race_stand", "label": "公共看台", "position": Vector2(2525, 720), "color": Color("a8dfb1"), "area": "逐风海岸"},
	{"id": "stable", "label": "马厩与骑师区", "position": Vector2(2810, 575), "color": Color("d6b47d"), "area": "逐风海岸"},
	{"id": "vip_terrace", "label": "贵宾露台入口", "position": Vector2(3045, 610), "color": Color("d8c47e"), "area": "逐风海岸"},
...
const MAP_LABEL_OFFSETS := {
	"basin": Vector2(-42, -7),
	"road_sign": Vector2(-48, 14),
	"granny": Vector2(6, 12),
	"shop": Vector2(-50, 12),
	"lifestyle": Vector2(-52, -7),
	"shopkeeper": Vector2(6, -7),
	"fish_market": Vector2(-42, 14),
	"exchange": Vector2(-42, 14),
	"square": Vector2(6, 14),
	"news": Vector2(-40, -7),
	"mia": Vector2(6, 12),
	"tea": Vector2(-48, 12),
	"old_joe": Vector2(6, -7),
	"race": Vector2(-62, -8),
	"race_ticket": Vector2(8, -8),
	"race_stand": Vector2(-48, 14),
	"stable": Vector2(8, -8),
	"vip_terrace": Vector2(-58, 14),
}
